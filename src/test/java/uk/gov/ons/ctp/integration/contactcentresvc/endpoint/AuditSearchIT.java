...
public class AuditSearchIT extends FullStackIntegrationTestBase {
  ...
  public void auditSearch() throws Exception {
    ...
    //  SuperUser  TeamLeader  null   USER       CREATED        --
    ...
    verifyAudit(audit, 2, USER_SU, null, "Admin", AuditType.PERMISSION, AuditSubType.ADDED, "READ_USER_AUDIT");
  ...
  private void verifyAudit(List<UserAuditDTO> auditList, int index, 
  ...
  public void noPermissionToAudit() throws Exception {
    ...
    ResponseEntity<String> audit = userEndpoint().invokeAudit(HttpStatus.UNAUTHORIZED, USER_TL, USER_TL, null);
