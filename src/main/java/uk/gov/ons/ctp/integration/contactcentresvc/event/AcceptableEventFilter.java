...
public class AcceptableEventFilter {
  ...
  @Autowired CollectionExerciseRepository collectionExerciseRepository;

  public boolean filterEvent(String surveyId, String collexId, String caseId, String messageId) {
