...
UPDATE role SET description='permitted to assist in bound callers' WHERE id='94be28c6-5b84-4946-81da-134b511d6ffc';
UPDATE role SET description='permitted to make out bound calls' WHERE id='632b71e4-479a-11ec-a941-4c3275913db5';
